...
export default function ConversationShow() {
    ...
    const handleSendMessage = async () => {
        ...
        try {
            ...
            console.log('Route:', route('proponent.conversations.messages.store', conversation.id));
            
            const response = await axios.post(
                route('proponent.conversations.messages.store', conversation.id),
                {
                    message: messageText,
