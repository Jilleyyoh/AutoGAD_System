                        ...
                        {conversations.total > 0 && (
                            <div className={combineTheme('px-6 py-4 border-t flex items-center justify-between', themeClasses.border.primary)}>
                                <div className={combineTheme('text-sm', themeClasses.text.secondary)}>
                                    Page <span className={combineTheme('font-semibold', themeClasses.text.primary)}>{conversations.current_page}</span> of <span className={combineTheme('font-semibold', themeClasses.text.primary)}>{Math.ceil(conversations.total / conversations.per_page)}</span>
