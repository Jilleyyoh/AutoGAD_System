...
export default function Certificates({ certificates = [], error, highlightCertificateId }: Props) {
  ...
  const getStatusBadge = (status: string) => {
    // Use standardized global status color scheme
      ...
      <div className="min-h-screen bg-white dark:bg-black">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="mb-8">
            ...
            <p className="text-gray-600 dark:text-gray-400 mt-2">View and download your project certifications</p>
          </div>
          ...
          <div className="mb-6">
            ...
            <input
              ...
              placeholder="Search by project title, code, or status..."
                    ...
                    <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                      <div className="flex-1">
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
                          ...
                          <div>
                            <p className="text-gray-500 dark:text-gray-500 text-xs uppercase">Certification Date</p>
                            <p className="font-semibold text-gray-900 dark:text-gray-100">{cert.certification_date}</p>
                          </div>
                        </div>
                      </div>
                      ...
                      {cert.can_download ? (
                        <a
                          href={route('proponent.certificates.download', cert.id)}
