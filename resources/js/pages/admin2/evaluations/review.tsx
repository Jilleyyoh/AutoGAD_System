...
export default function Review({ project, evaluations, average_score, evaluation_count, interpretations }: Props) {
    ...
    const getAverageScoreColors = (score?: number) => {
        const interpretationIndex = score === undefined
            ? -1
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
                    ...
                    >
                        <div className="flex items-start justify-between">
                            ...
                            <CheckCircle2 className="w-16 h-16" style={{ color: getAverageScoreColors(average_score).accentColor }} />
                        </div>
                    </div>
