...
export default function Notifications({ notifications }: NotificationsProps) {
  ...
  const getTypeColor = (type: string) => {
    const colors: Record<string, string> = {
      'evaluation_assigned': 'bg-blue-100 dark:bg-blue-900 text-blue-800 dark:text-blue-200',
      'evaluation_completed_approved': 'bg-green-100 dark:bg-green-900 text-green-800 dark:text-green-200',
      'project_approved_for_certification': 'bg-purple-100 dark:bg-purple-900 text-purple-800 dark:text-purple-200',
    }
  ...
  const getTypeLabel = (type: string) => {
    const labels: Record<string, string> = {
      ...
      'evaluation_completed_approved': 'Evaluation Approved',
      'project_approved_for_certification': 'Project Approved',
    }
