                ...
                <div className={combineTheme('px-4 sm:px-0', themeClasses.text.primary)}>
                    ...
                    <div className="mb-8 flex items-center justify-between">
                        ...
                        <Link
                            ...
                            className={combineTheme('flex items-center gap-2 px-6 py-3 rounded-lg transition-colors', themeClasses.button.primary)}
                        >
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                        <Link
                            href="/evaluator/evaluations"
                            className={combineTheme('bg-gradient-to-br border-2 rounded-lg p-6 hover:shadow-lg transition-shadow cursor-pointer', `bg-gradient-to-br ${themeClasses.gradient.blue} ${themeClasses.borderAccent.blue}`)}
                        >
                            <div className="flex items-center gap-4">
                                ...
                                <div>
                                    <h3 className={combineTheme('text-lg font-semibold', 'text-blue-900 dark:text-blue-100')}>
                                        My Evaluations
                                    </h3>
                                    <p className={combineTheme('text-sm', 'text-blue-700 dark:text-blue-200')}>
                                        View and complete assigned project evaluations
                                    </p>
                                </div>
                            </div>
                        </Link>

                        <div className={combineTheme('bg-gradient-to-br border-2 rounded-lg p-6', `bg-gradient-to-br ${themeClasses.gradient.purple} ${themeClasses.borderAccent.purple}`)}>
                            <div className="flex items-center gap-4">
                                <div className="bg-purple-600 dark:bg-purple-500 rounded-lg p-3">
                                    <BarChart3 className="w-6 h-6 text-white" />
                                </div>
                                <div>
                                    <h3 className={combineTheme('text-lg font-semibold', 'text-purple-900 dark:text-purple-100')}>
                                        Evaluation Statistics
                                    </h3>
                                    <p className={combineTheme('text-sm', 'text-purple-700 dark:text-purple-200')}>
                    ...
                    {/* Info Section */}
                    <div className={combineTheme('border rounded-lg p-6 mb-8', themeClasses.alert.info)}>
                        <h2 className={combineTheme('text-lg font-semibold mb-2', 'text-blue-800 dark:text-blue-100')}>
                            👋 Welcome to the Evaluation System
                        </h2>
                        <p className={combineTheme('', 'text-blue-700 dark:text-blue-100')}>
                    ...
                    <div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                            {[
                                { icon: '📋', title: 'View Projects', desc: 'See all projects assigned to you with filtering and search', borderColor: 'border-blue-500 dark:border-blue-600' },
                                { icon: '📊', title: 'Score Questionnaire', desc: 'Complete comprehensive evaluation questionnaires with scoring', borderColor: 'border-green-500 dark:border-green-600' },
                                { icon: '💾', title: 'Save Progress', desc: 'Save your evaluation progress and return to complete it later', borderColor: 'border-purple-500 dark:border-purple-600' },
                                { icon: '✅', title: 'Submit Evaluation', desc: 'Submit your completed evaluations to the admin team for review', borderColor: 'border-yellow-500 dark:border-yellow-600' },
                            ].map((feature) => (
                                <div
                                    key={feature.title}
