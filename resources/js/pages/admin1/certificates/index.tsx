  ...
  return (
    <AppLayout
      breadcrumbs={[
        ...
        { title: 'Certificates', href: route('admin1.certificates.index') }
      ]}
      sidebarOpen={true}
    >
      ...
      <div className="min-h-screen bg-white dark:bg-black">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="mb-8">
            ...
            <p className="text-gray-600 dark:text-gray-400 mt-2">View and download all certified project certificates</p>
          </div>
          ...
          <div className="mb-6">
            ...
            <input
              ...
              placeholder="Search by project title, code, proponent, or organization..."
                ...
                >
                  <div className="p-6">
                    <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                      ...
                      {cert.can_download ? (
                        <a
                          href={route('admin1.certificates.download', cert.id)}
