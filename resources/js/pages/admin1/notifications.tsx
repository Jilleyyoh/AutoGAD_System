...
export default function Notifications({ notifications }: NotificationsProps) {
  ...
  const getTypeColor = (type: string) => {
    const colors: Record<string, string> = {
      ...
      'project_resubmitted': 'bg-yellow-100 dark:bg-yellow-900 text-yellow-800 dark:text-yellow-200',
      'evaluation_completed': 'bg-green-100 dark:bg-green-900 text-green-800 dark:text-green-200',
      'certificate_generated': 'bg-purple-100 dark:bg-purple-900 text-purple-800 dark:text-purple-200',
      'message_received': 'bg-orange-100 dark:bg-orange-900 text-orange-800 dark:text-orange-200',
      'project_assigned': 'bg-indigo-100 dark:bg-indigo-900 text-indigo-800 dark:text-indigo-200',
    }
  ...
  const getTypeLabel = (type: string) => {
    const labels: Record<string, string> = {
      ...
      'project_resubmitted': 'Project Resubmitted',
  ...
  return (
    <AppLayout>
      <Head title="Admin 1 - Notifications" />
      ...
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center gap-3">
          ...
          <h1 className="text-3xl font-bold text-gray-900 dark:text-white">Admin 1 - Notifications</h1>
        </div>
      ...
      {hasNotifications ? (
        ...
        <div className="text-center py-12">
          ...
          <p className="text-sm text-gray-400 dark:text-gray-500 mt-1">
            {activeTab === 'unread' 
              ? "You'll see notifications here when something important happens with system administration"
