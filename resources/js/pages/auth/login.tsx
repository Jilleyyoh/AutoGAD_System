                ...
                <div className="grid gap-6">
                    ...
                    <div className="grid gap-2">
                        <div className="flex items-center">
                            ...
                            {canResetPassword && (
                                <TextLink href={route('password.request')} className="ml-auto text-sm text-white hover:text-gray-300" tabIndex={5}>
                                    Forgot password?
                                </TextLink>
                            )}
                        </div>
                    ...
                    <div className="flex items-center space-x-3">
                        <Checkbox 
                            ...
                            tabIndex={3} 
                            className="border-gray-300 dark:border-gray-700 data-[state=checked]:bg-purple-600 data-[state=checked]:border-purple-600" 
                        />
