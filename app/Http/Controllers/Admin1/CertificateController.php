...
{
    /**
     * Display list of all certificates (for Admin1)
     */
    public function index(Request $request)
    {
        try {
            ...
            if (!$user) {
                return Inertia::render('admin1/certificates/index', [
                    'certificates' => [],
            ...
            // Get all certificates (Admin1 can view all)
            ...
            \Log::error('Error fetching admin1 certificates', [
